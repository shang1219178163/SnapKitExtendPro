//
//  UITableViewCellSudokuButtonReverse.swift
//  SnapKitExtendPro_Example
//
...
import UIKit
import SwiftExpand
import SnapKitExtendPro

///九宫格

@objcMembers class UITableViewCellSudokuButtonReverse: UITableViewCell {
...
//        items.snp.distributeSudokuViews(fixedLineSpacing: lineSpacing, fixedInteritemSpacing: interitemSpacing, warpCount: numOfRow, edgeInset: inset)
        items.snp.distributeSudokuViewsReverse(fixedLineSpacing: lineSpacing, fixedInteritemSpacing: interitemSpacing, warpCount: numOfRow, edgeInset: inset)
        //        items.snp.distributeSudokuViews(fixedLineSpacing: lineSpacing, fixedInteritemSpacing: interitemSpacing, warpCount: numOfRow, edgeInset: inset)
